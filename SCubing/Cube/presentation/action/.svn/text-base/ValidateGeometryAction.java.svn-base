...
import presentation.layout.JProgressWindow;
...
public class ValidateGeometryAction extends SafeAction {
   ...
   public void action(ActionEvent e) throws Throwable {
    ...
    private int validateFeatureGeometry(ProgressListener progress) throws Exception {
        final SimpleFeatureCollection featureCollection = MapFrame.getInstance().getSelectedLayerFeatureSource().getFeatures();
